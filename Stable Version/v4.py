...
BOX_WIDTH = 450
BOX_HEIGHT = 350
BOX_WIDTH_PREVIEW =400
BOX_HEIGHT_PREVIEW = 350
...
class PassportPhotoApp:
    def __init__(self, window):
        self.window = window
        self.window.title("ID Pro Photo Capture")
        self.window.geometry("1000x700")
        self.window.configure(bg="#f0f0f0")

        # Title Label
        self.title_label = Label(self.window, text="ID Pro Photo Capture", font=("Arial", 20, "bold"), bg="#f0f0f0")
        ...
        self.right_frame = Frame(self.container_frame, bd=2, relief="groove", bg="white", width=BOX_WIDTH_PREVIEW, height=BOX_HEIGHT_PREVIEW)
    ...
    def preview_image(self, image):
        ...
        image_preview = image.resize((BOX_WIDTH_PREVIEW, BOX_HEIGHT_PREVIEW))  # Resize for preview
